            ...
            foreach ($service as $key => $value) {
                ...
                if ('deprecated' === $key) {
                    ...
                    if (!isset($deprecation['package'])) {
                        trigger_deprecation('symfony/dependency-injection', '5.1', 'Not setting the attribute "package" of "deprecated" is deprecated.');
                    }

                    if (!isset($deprecation['version'])) {
                        trigger_deprecation('symfony/dependency-injection', '5.1', 'Not setting the attribute "version" of "deprecated" is deprecated.');
                    }
