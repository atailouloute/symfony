...
use Symfony\Component\Routing\Matcher\EnvVarResolver;
...
trait CompiledUrlMatcherTrait
{
    ...
    private function doMatch(string $pathinfo, array &$allow = [], array &$allowSchemes = []): array
    {
        ...
        foreach ($this->staticRoutes[$trimmedPathinfo] ?? [] as list($ret, $requiredHost, $requiredMethods, $requiredSchemes, $hasTrailingSlash, , $condition)) {
            if ($condition && !($this->checkCondition)($condition, $context, 0 < $condition ? $request ?? $request = $this->request ?: $this->createRequest($pathinfo) : null, $this->envVarResolver ?? null)) {
                continue;
            }
